...
# Секретный ключ для защиты проекта
...
INSTALLED_APPS = [
    ...
    'django.contrib.auth', 
    # Приложение аутентификации Django
    'django.contrib.contenttypes', 
    # Приложение управления типами контента Django
    'django.contrib.sessions', 
    # Приложение управления сессиями Django
    'django.contrib.messages', 
    # Приложение управления сообщениями Django
    'django.contrib.staticfiles', 
    # Приложение управления статическими файлами Django
...
MIDDLEWARE = [
    ...
    # Middleware для работы с сообщениями
...
TEMPLATES = [
    {
        ...
        # Используемый бэкенд для шаблонов
        ...
        'OPTIONS': {
            'context_processors': [
                ...
                # Добавляет объект request в контекст шаблонов
                'django.contrib.auth.context_processors.auth', 
                # Добавляет переменные аутентификации в контекст шаблонов
                'django.contrib.messages.context_processors.messages', 
                # Добавляет сообщения в контекст шаблонов
            ],
        },
    },
]
...
AUTH_PASSWORD_VALIDATORS = [
    {
        ...
        # Валидатор схожести с пользовательскими атрибутами
    },
    {
    ...
    },
    {
        ...
        # Валидатор распространенных паролей
    },
    {
        'NAME': 'django.contrib.auth.password_validation.NumericPasswordValidator', 
        # Валидатор паролей только из цифр
    },
]
...
# Тип поля для
#автогенерируемых первичных ключей